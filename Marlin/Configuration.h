...
#define STRING_CONFIG_H_AUTHOR "(Robbiedobbie, MyLittlePrusa 0.2.2)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "3D Slave"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "765265c6-832e-4d1c-ba13-08d11c0e1826"
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 308.45
    #define  DEFAULT_bedKi 22.96
    #define  DEFAULT_bedKd 1036.01
...
#define THERMAL_RUNAWAY_PROTECTION_HYSTERESIS 6 // in degree Celsius
...
#define HOMING_FEEDRATE {1000, 1000, 140, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4015,700/1.26}  // default steps per unit for Ultimaker
...
#define DEFAULT_RETRACT_ACCELERATION  2800   // X, Y, Z and E max acceleration in mm/s^2 for retracts
...
// Preheat Constants
#define PLA_PREHEAT_HOTEND_TEMP 202
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 165,0} // X,Y,Z Axis Extend and Retract angles
